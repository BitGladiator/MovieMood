          ...
          {[
            ...
            >
              ...
              <div
                ...
                } from-black/90 via-black/30 to-black/90 pointer-events-none`}
              ></div>
            </motion.div>
          ))}
        </div>
      ...
      >
        ...
        <div className="p-10">
          <div className="mb-10 text-center">
            ...
            <h1 className="text-2xl font-medium text-neutral-100 tracking-wider">
              CINEMATIC UNIVERSE
            </h1>
            <p className="text-sm text-neutral-400 mt-2">
              Access your personal movie collection
            </p>
          </div>
