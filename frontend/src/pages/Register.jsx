...
import { signup } from "../firebase"; // make sure this path points to your Firebase logic
    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white">
      <form onSubmit={handleSubmit} className="bg-white/5 p-8 rounded-xl border border-white/10 backdrop-blur-md w-full max-w-md">
        ...
        <input
          ...
          required
        />
        <button className="bg-indigo-600 hover:bg-indigo-700 w-full py-3 rounded">Register</button>
      </form>
    </div>
  );
}
